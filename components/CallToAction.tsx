      ...
      <div className="relative bg-gray-900 shadow-lg rounded-3xl dark:bg-gray-200 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-20 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-2xl tracking-tight text-gray-100 sm:text-4xl sm:tracking-tight dark:text-gray-900">
            ...
            <span className="block text-gray-400 dark:text-gray-700 text-xl mt-2">
            ...
            <a
              ...
              className="focus:ring-2 ring-offset-2 ring-white ring-offset-gray-900 mt-3 whitespace-nowrap inline-flex items-center justify-center px-6 py-3 rounded-3xl shadow-sm text-base font-medium text-black bg-gradient-to-br hover:bg-gradient-to-tl from-gray-200 to-gray-400 dark:from-gray-900 dark:to-gray-700 dark:text-white dark:ring-white dark:hover:from-gray-700 dark:hover:to-gray-900"
            >
              Get started
            </a>
          </h2>
