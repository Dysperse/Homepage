  ...
  return (
    <>
      <section className="h-auto sm:min-h-[750px] sm:h-[calc(100vh-100px)] xl:h-[calc(100vh-100px)] px-5 sm:px-0">
        <div className="bg-gray-100 rounded-2xl max-w-5xl mx-auto p-3 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-10 mb-10 sm:mb-0">
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 h-full items-center">
          <div className="-top-4 sm:top-0 relative order-1 sm:order-[unset] flex flex-col sm:col-span-3 justify-center">
            <div className="max-w-4xl mx-auto">
              <h1
                ...
                className="text-center sm:text-left text-5xl sm:text-6xl md:text-7xl lg:text-8xl 2xl:text-9xl leading-none cursor-default"
              >
              ...
              <div className="flex gap-3 flex-col sm:flex-row justify-center sm:justify-start">
                ...
                >
                  I'm intrigued
                  <div className="ml-2 lg:ml-7 w-9 h-9 lg:w-12 lg:h-12 text-black flex items-center justify-center bg-white rounded-full -mr-3 lg:-mr-10">
          ...
          {/* sm:-mr-80 md:-mr-52 ml-80 sm:ml-5 xl:ml-52 xl:mt-10 2xl:ml-80 */}
          <div
            className="h-auto flex-1 -mr-20 ml-24 sm:ml-0 sm:-mr-44 col-span-2"
            style={{
              position: "relative",
