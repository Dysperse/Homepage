      ...
      <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
          <div className="sm:max-w-lg">
            <h1 className="mt-10 md:mt-[100px] text-5xl font text-transparent text-8xl bg-clip-text bg-gradient-to-tl from-green-400 to-green-900 font-[400] tracking-tight text-gray-900 sm:tracking-tight sm:text-6xl">
              Next-gen home inventory and personal finances
            </h1>
            <p className="mt-4 text-lg text-gray-500">
              Ever been stuck at the grocery store wondering what you need? Smartlist helps you organize your home&apos;inventory, expenses, task, and more.
            </p>
            <a
              href="#"
